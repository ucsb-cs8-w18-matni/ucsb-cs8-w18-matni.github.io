...
num: lab02
ready: true
desc: "Accumulator Functions and More Turtle Graphics"
...
You will write a function called <b>factorial(n)</b> that computes the product of the first N numbers, where N is a parameter. For example, factorial(4) is calculated as 1 * 2 * 3 * 4, so the function should return the value 24. We will assume N is greater than 0. I did a similar exercise in lecture.

Be sure to understand the purpose and meaning of each of the following instructions before you execute them.

<ol type="a">

<li>Skip a blank line (in your lab02.py file) under the first 4 lines, and then type a brief comment for a factorial function such as the following:
  <pre>
